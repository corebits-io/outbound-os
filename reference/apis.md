...
## Adding tools later
If the user adds **Smartlead** (alt sequencer), a **LinkedIn** sender, or a phone-dial tool, create a new playbook and add its key + a section here. Keep the same "read live docs first, dry-run, then batch" discipline.
